...
path<-"/data/Run1" #Unzipped fastq file
...
pdf("plotqual_F_run1_maxee24.pdf")
plotQualityProfile(fnFs[1:8])
dev.off()

pdf("plotqual_R_run1_maxee24.pdf")
...
pdf("ploterr_F_run1_maxee24.pdf")
...
class(seqtab) #matrix
dim(seqtab)
saveRDS(seqtab, "seqtabrun1_24.rds")
